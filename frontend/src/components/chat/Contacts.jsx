...
const Contacts = ({ contacts, handleSelectContact, selectedContact }) => {
  ...
  return (
    <div className="border-r border-[#000000] flex flex-col h-full overflow-hidden">
      <div className="flex flex-row gap-3 px-4 py-3">
        ...
        <button className="bg-black rounded-lg flex items-center justify-center aspect-square h-full hover:border hover:border-dark-gray">
