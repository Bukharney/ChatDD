...
const SearchModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[#000000] bg-opacity-50 flex items-center justify-center">
      <div className="bg-[#000000] rounded-xl p-4 w-[75vw] lg:w-[35vw] border-2 border-dark-gray">
        ...
        <form onSubmit={handleSearch} className="flex flex-row gap-3 items-center">
          <input
            ...
            className="w-full  text-xs lg:text-sm p-3 bg-black border-none outline-none rounded-xl text-white placeholder-gray focus:outline-none focus:ring-1 focus:ring-blue focus:border-transparent"
